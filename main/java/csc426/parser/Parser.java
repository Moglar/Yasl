...
public class Parser {
    ...
    /**
     *
     * Each of the following methods generally follows the same pattern.
     * Tell the parser what to expect and give it some rules on how to move forward based on input.
     * Do some magical recursion that 'descends' us to the bottom of the particular branch in the AST.
     *
     */
    ...
    /**
     *
     * Here we have reached the end of our descent down a branch.
     * If something funny happened, write Error to log, Else
     * Throw Party
     *
     */
